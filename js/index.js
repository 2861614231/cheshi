    ...
    $(function(){
        ...
        option = {
            legend: {
                orient : 'vertical',
                x : 'left',
                data:['沉砂池','沉淀池','调节池','','疏解器'], textStyle:{
                    color:"#e9ebee"
    ...
    $(function(){
        ...
        option = {
            ...
            legend: {
                orient : 'vertical',
                x : 'left',
                data:['大型异物','颗粒物质','塑料杂物','悬浮固体颗粒','纤维布料','小型生物','其他'], textStyle:{
                    color:"#e9ebee"
            ...
            series : [
                {
                    name:'出水',
                    type:'bar',
                    data:[10, 8, 6, 4, 7, 5, 8, 4.4, 2, 4.5, 6.7, 2.3],
                    markPoint : {
                        data : [
                            {type : 'max', name: '最大值'},
                            {type : 'min', name: '最小值'}
                ...
                },
                {
                    name:'进水',
                    type:'bar',
                    data:[100, 80, 60, 40, 70, 50, 80, 44, 20,45, 67, 23],
                    markPoint : {
                        data : [
            ...
            series: [
                {
                    ...
                    type: 'line',
                    stack: '订单数',
                    data:[110,201, 302,345, 400, 206, 170, 230, 321, 234, 345, 432],
                    itemStyle: {
                        normal: {
                            color: '#02bcbc'
                        }
